package com.microsoft.azure.tbcode.eventhub;
...
public class TBCodeEventHubClient {
	...
	public static void main(String[] args)
		...
		if (args == null || args.length < 2) {
			System.out.println(
					"Usage: TBCodeEventHubClient [properties file path] [send/receive]");
			return;
		}
	...
	private static void receiveEvents(EventHubClient client, String[] partitionIds)
		...
		for (String partitionId : partitionIds) {
			...
			TBCodePartitionReceiveHandler receiveHandler = new TBCodePartitionReceiveHandler(MAX_EVENT_COUNT,
