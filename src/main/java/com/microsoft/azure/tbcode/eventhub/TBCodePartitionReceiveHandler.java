...
public class TBCodePartitionReceiveHandler extends PartitionReceiveHandler {
	
	String partitionId;
	String consumerGroupName;

	protected TBCodePartitionReceiveHandler(int maxEventCount, String partitionId, String consumerGroupName) {
		super(maxEventCount);
